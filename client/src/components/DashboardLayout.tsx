...
import { LayoutDashboard, LogOut, PanelLeft, Plus, Sparkles } from "lucide-react";
...
const menuItems = [
  { icon: LayoutDashboard, label: "Acervo", path: "/" },
  { icon: Plus, label: "Nova marca", path: "/nova-marca" },
];
...
export default function DashboardLayout({
  ...
  useEffect(() => {
    ...
    if (Number.isFinite(parsedWidth) && parsedWidth >= MIN_WIDTH && parsedWidth <= MAX_WIDTH) {
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Este ateliê é reservado para a sua equipe. Continue para iniciar o acesso seguro.
            </p>
          </div>
          <Button
            onClick={() => startLogin()}
